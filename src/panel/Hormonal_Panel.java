 ...
 * @author Wei Wang
 */
public class Hormonal_Panel extends Panel {
        public Hormonal_Panel(){
        super();
        this.testName = "Hormonal";
        this.DBTableNameArr = new String[]{"`vibrant_america_test_result`.`Result_Hormonal_Panel`"};
        this.DBMasterListTableNameArr = new String[]{"`vibrant_america_test_result_ml`.`master_list_Hormonal_Panel`"};
        this.DBRefRangeTable = "vibrant_america_information.report_master_list_tracking";
        
        this.testCodeArr = new String[]{"`CORT`",
                                        "`PTH`",
                                        "`ESTRA`",
                                        "`FSH`",
                                        "`LH`",
