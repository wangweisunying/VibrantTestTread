 ...
 * @author Wei Wang
 */
public class Cardiology_Panel extends Panel{
    public Cardiology_Panel(){
        super();
        this.testName = "Cardiology";
        this.DBTableNameArr = new String[]{"`vibrant_america_test_result`.`result_cardiology_panel`"};
        this.DBMasterListTableNameArr = new String[]{"`vibrant_america_test_result_ml`.`master_list_cardiology_panel`"};
        this.DBRefRangeTable = "vibrant_america_information.report_master_list_tracking";
        
        this.testCodeArr = new String[]{"`CHOL`",
                                        "`LDL`",
                                        "`HDL`",
                                        "`TRIG`",
                                        "`APOA`",
