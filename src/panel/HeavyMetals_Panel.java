 ...
 * @author Wei Wang
 */
public class HeavyMetals_Panel extends Panel{
    
        public HeavyMetals_Panel() {
        super();
        this.testName = "Heavy_Metals";

        this.DBTableNameArr = new String[]{"`vibrant_america_test_result`.`result_heavy_metals_panel1`",
            "`vibrant_america_test_result`.`result_heavy_metals_panel2`"};
        
        
        this.DBMasterListTableNameArr = new String[]{"`vibrant_america_test_result_ml`.`master_list_heavy_metals_panel1`",
                                                    "`vibrant_america_test_result_ml`.`master_list_heavy_metals_panel2`"};
        

        this.DBRefRangeTable = "vibrant_america_information.report_master_list_tracking";

        this.testCodeArr = new String[]{"`ALUMINUM__24_HOUR_URINE`",
                                        "`ANTIMONY__24_HOUR_URINE`",
                                        "`ARSENIC__24_HOUR_URINE`",
                                        "`BARIUM__24_HOUR_URINE`",
                                        "`BERYLLIUM__24_HOUR_URINE`",
                                        "`BISMUTH__24_HOUR_URINE`",
                                        "`CADMIUM__24_HOUR_URINE`",
                                        "`CESIUM__24_HOUR_URINE`",
                                        "`GADOLINIUM__24_HOUR_URINE`",
                                        "`LEAD__24_HOUR_URINE`",
                                        "`MERCURY__24_HOUR_URINE`",
                                        "`NICKEL__24_HOUR_URINE`",
                                        "`PALLADIUM__24_HOUR_URINE`",
                                        "`PLATINUM__24_HOUR_URINE`",
                                        "`TELLURIUM__24_HOUR_URINE`",
                                        "`THALLIUM__24_HOUR_URINE`",
                                        "`THORIUM__24_HOUR_URINE`",
                                        "`TIN__24_HOUR_URINE`",
                                        "`TUNGSTEN__24_HOUR_URINE`",
                                        "`URANIUM__24_HOUR_URINE`",
                                        "`URINE_CREATININE`",
                                        "`ALUMINUM_CREATININE`",
                                        "`ANTIMONY_CREATININE`",
                                        "`ARSENIC_CREATININE`",
                                        "`BARIUM_CREATININE`",
                                        "`BERYLLIUM_CREATININE`",
                                        "`BISMUTH_CREATININE`",
                                        "`CADMIUM_CREATININE`",
                                        "`CESIUM_CREATININE`",
                                        "`GADOLINIUM_CREATININE`",
                                        "`LEAD_CREATININE`",
                                        "`MERCURY_CREATININE`",
                                        "`NICKEL_CREATININE`",
                                        "`PALLADIUM_CREATININE`",
                                        "`PLATINUM_CREATININE`",
                                        "`TELLURIUM_CREATININE`",
                                        "`THALLIUM_CREATININE`",
                                        "`THORIUM_CREATININE`",
                                        "`TIN_CREATININE`",
                                        "`TUNGSTEN_CREATININE`",
    ...
    public static void main(String[] args) {
        HeavyMetals_Panel test = new HeavyMetals_Panel();
        test.getDupMap();
//        test.getRefMap("");
    }
...
"WHERE\n" +
"   (slt.Order_heavy_metals_panel1!= 0  OR slt.Order_heavy_metals_panel2 != 0)\n" +
